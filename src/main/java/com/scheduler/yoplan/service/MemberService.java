...
public class MemberService implements IMemberService {
    ...
    public int regiMember(MemberVO member) {
        return mMapper.rigiMember(member);
    }
    ...
    private MimeMessage createMessage(String to)throws Exception{
        ...
        message.setSubject("yoplan 이메일인증");//제목

        String msgg="";
        msgg+= "<div style='margin:20px;'>";
        msgg+= "<h1> 안녕하세요 요플랜입니다. </h1>";
        msgg+= "<br>";
        ...
        message.setFrom(new InternetAddress("olllo12010@gmail.com","yoplan"));//보내는 사람
